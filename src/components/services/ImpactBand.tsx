...
export function ImpactBand() {
  return (
    <section data-section="s05-we-get-the-job-done" className="block w-full bg-primary text-surface">
      <div className="mx-auto flex min-h-[173px] max-w-content flex-col items-center justify-center gap-tight px-4 py-band text-center md:px-gutter">
